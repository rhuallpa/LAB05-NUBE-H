...
ALLOWED_HOSTS = ['18.191.191.233', 'localhost', '127.0.0.1']
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',  # Puedes usar otros motores de bases de datos compatibles con Django
        'NAME': 'demo_1',
        'USER': 'rebeca',
        'PASSWORD': 'password',
        'HOST': 'database-1.ckt8wggwrmmo.us-east-2.rds.amazonaws.com',
